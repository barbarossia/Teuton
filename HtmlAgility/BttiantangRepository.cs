...
{
    public class BttiantangRepository : ISearch
    {
        private ISearchResultSelector selector = new BttiantangSelector();
        ...
        private List<DownloadContent> SearchCore(string url)
        {
